...
public static function getAllActors()
{
	...
	$stmt=$connection->prepare("
		SELECT a.id AS 'actor_id', a.first_name, a.last_name, a.rating, a.favorite_movie_id, m.title AS favorite_movie_title
		FROM actors as a
		...
		foreach ($actors as $actor) {
			...
			$finalActor->setFavoriteMovieTitle($actor['favorite_movie_title']);

		$actorsObjets[]=$finalActor;
		}
		return $actorsObjets;
	}
